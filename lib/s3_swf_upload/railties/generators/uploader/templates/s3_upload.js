...
function s3_swf_init(id, options)
{
  ...
  var fileName        					= (options.fileName != undefined) ? 								options.fileName : 								"";
  ...
  s3_swf = {
    ...
    init: function() { this.obj().init(signatureUrl, keyPrefix, fileName, fileSizeLimit, queueSizeLimit, fileTypes, fileTypeDescs, selectMultipleFiles,buttonWidth,buttonHeight,buttonUpUrl,buttonDownUrl,buttonOverUrl); },
